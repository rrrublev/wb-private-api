  ...
  describe("Проверка версий API в URL", () => {
    ...
    test("Домены должны быть корректными", () => {
      const expectedDomains = {
        ...
        "wbbasket.ru": ["PRODUCT.CARD", "PRODUCT.SELLERS", "IMAGES.TINY", "IMAGES.BIG", "IMAGES.SMALL", "IMAGES.MEDIUM"],
        "wbstatic.net": ["BRAND.IMAGE", "PRODUCT.CONTENT", "IMAGES.FEEDBACK_BASE"],
